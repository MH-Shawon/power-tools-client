...
const Info = () => {
    return (
        <div className='grid gap-5 px-20 lg:grid-cols-2 sm:grid-cols-1'>
            <div class="card card-compact bg- shadow-xl p-3 bg-[#2E2E2E]">
                <div class="p-5 lg:flex lg:flex-row lg:justify-between lg:items-center block">
                    <div className='text-white'>
                        ...
                        <button class="btn btn-sm bg-[#FBC42D] mt-4">Buy Now</button>
                    </div>
            ...
            <div class="card card-compact bg- shadow-xl p-3 bg-[#FE9116]">
                <div class="p-5 lg:flex lg:flex-row lg:justify-between lg:items-center block">
                    <div className='text-white'>
                        <p className='uppercase'>From, Bestelliers</p>
                        <h2 class="card-title my-3 text-2xl">WORX Tools</h2>
