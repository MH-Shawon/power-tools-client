...
import { MdEditCalendar, MdEmail, MdOutlinePayment, MdProductionQuantityLimits, MdReviews } from "react-icons/md";
...
const DashboardLayout = () => {
    ...
    // console.log(isAdmin); // should correctly log the admin status
